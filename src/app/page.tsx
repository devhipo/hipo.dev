export default function Home() {
  return (
    <>
      <header className="text-gray-600 body-font bg-hipo-bg">
        <div className="container mx-auto flex px-10 p-3 flex-col md:flex-row items-center justify-between">
          <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0" href="/">
            <img alt="hipo.dev" className="h-10" src="img/horizontal-logo-regular-black.svg"/>
          </a>
          <a href="https://github.com/devhipo/hipo" target="_blank">
            <svg className="h-6 fill-gray-100" version="1.1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
      ...
      <section className="text-gray-400 bg-hipo-bg2 body-font px-36 p-24">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            <div className="font-code p-5 bg-black border border-gray-600 rounded-lg">
              <div className="mb-4 flex gap-1.5">
                <svg className="h-3 fill-stone-700" version="1.1" viewBox="0 0 16 16"  xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="8" r="8"/></svg>
                <svg className="h-3 fill-stone-700" version="1.1" viewBox="0 0 16 16"  xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="8" r="8"/></svg>
                <svg className="h-3 fill-stone-700" version="1.1" viewBox="0 0 16 16"  xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="8" r="8"/></svg>
              </div>
              {/* eslint-disable-next-line react/no-unescaped-entities */}
              <span className="text-teal-800">curl</span> -s <span className="text-yellow-600">"https://get.hipo.dev"</span> | bash<br />
              <span className="text-teal-800">hipo</span> dev.hipo:hello<br/><br/>
      ...
      <section className="text-gray-400 bg-hipo-bg3 body-font px-12">
      ...
      <section className="text-gray-400  bg-hipo-bg2 body-font px-12">
      ...
      <footer className="text-gray-400 bg-black body-font px-12">
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-white" href="/">
            <img alt="hipo.dev" className="h-8" src="img/horizontal-logo-light-tr.svg"/>
          </a>
